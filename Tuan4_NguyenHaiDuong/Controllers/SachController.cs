...
namespace Tuan4_NguyenHaiDuong.Controllers
{
    public class SachController : Controller
    {
        ...
        public ActionResult Edit(int id, FormCollection collection)
        {
            ...
            var E_tensach = collection["tensach"];
            var E_hinh = collection["hinh"];
            var E_giaban = Convert.ToDecimal(collection["giaban"]); var E_ngaycapnhat = Convert.ToDateTime(collection["ngaycatnhat"]); var E_soluongton = Convert.ToInt32(collection["soluongton"]); 
            E_sach.masach = id;
